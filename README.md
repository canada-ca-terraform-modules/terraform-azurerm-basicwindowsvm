...
Example variable for a NIC with 2 staticly assigned IP:

```hcl
nic_ip_configuration = {
  private_ip_address            = ["10.20.30.42","10.20.40.43"]
  private_ip_address_allocation = ["Static","Static"]
}
```

Example variable for a NIC with 1 dynamically assigned IP:
...
| Date     | Release    | Change                                                                            |
| -------- | ---------- | --------------------------------------------------------------------------------- |
| 20190827 |            | Add support for multiple IP assigned the NIC                                      |
